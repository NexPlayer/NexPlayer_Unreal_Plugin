...
The NexPlayer™ for Unreal Engine video streaming player is developed entirely **in-house**. Therefore, it is fully customizable and we can implement any desired functionalities. 
